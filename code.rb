...
twitter_data.each do |person|
  person.each do |key, data|
    if data["description"] != nil
    puts "#{key}: " + data["description"].to_s
    end
  end
end
...
twitter_data.each do |person|
  person.each do |key, data|
    puts "#{key}: " + data["number of followers"].to_s
  end
end
...
twitter_data.each do |person|
  person.each do |key, data|
    if data["latest tweet"]
      puts "#{key}'s latest tweet was " + data["latest tweet"].length.to_s + " characters long."
    end
  end
end
...
twitter_data.each do |person|
  person.each do |key, data|
    ...
    data["last twenty tweets"].each do |tweet|
      total_length += tweet.length
    end
    puts "#{key} used " + total_length.to_s + " characters in their last twenty tweets."
  end
end

puts

#The code below address the second part: "Write code to answer the following ?s"
max_followers = 0
name = " "

twitter_data.each do |hashes|
  hashes.each do |key, value|
    if value["number of followers"] > max_followers
      max_followers = value["number of followers"]
      name = key
    end
  end
end

puts "#{name} has #{max_followers} followers: the most!"
puts
...
twitter_data.each do |hashes|
  hashes.each do |key, value|
    if value["number of friends"] > max_friends
      max_friends = value["number of friends"]
      name = key
    end
  end
end

puts "#{name} has #{max_friends} friends: the most!"
puts
...
twitter_data.each do |hashes|
  hashes.each do |key, value|
    if value["number of tweets"] > max_tweets
      max_tweets = value["number of tweets"]
      name = key
    end
  end
end

puts "#{name} has #{max_tweets} tweets: the most!"

puts
puts "These people have descriptions: "
...
puts
puts "These people have a location listed: "
